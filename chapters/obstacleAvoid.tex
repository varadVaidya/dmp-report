...
\begin{figure}[!htp]
    \centering
    \includegraphics[width= 0.32 \textwidth]{singlePB1_cropped.png}\quad
    \includegraphics[width= 0.32 \textwidth]{singlePB2_cropped.png}\quad
    \includegraphics[width= 0.32 \textwidth]{singlePB3_cropped.png}

    \medskip

    \includegraphics[width= 0.32 \textwidth]{singlePB4_cropped.png}\quad
    \includegraphics[width= 0.32 \textwidth]{singlePB5_cropped.png}
